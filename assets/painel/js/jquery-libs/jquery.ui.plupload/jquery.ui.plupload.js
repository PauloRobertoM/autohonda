(function(f, a, c, g, e) {
	...
	function d(i) {
		i
				.html('<div class="plupload_wrapper"><div class="ui-widget-content plupload_container"><div class="plupload"><div class="plupload_content"><table class="plupload_filelist"><tr class="ui-widget-header plupload_filelist_header"><td class="plupload_cell plupload_file_name">'
						+ b("Filename")
						//+ '</td><td class="plupload_cell plupload_file_extra">'
						//+ 'Largura'
						//+ '</td><td class="plupload_cell plupload_file_extra">'
						//+ 'Altura'
