				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add btn btn-small btn-danger" style="color:#fff;">' + _('Add Files') + '</a>&nbsp;' +
							//'<a class="plupload_button plupload_start btn btn-small btn-danger" style="color:#fff;">' + _('Start Upload') + '</a>&nbsp;' +
