...
(function($){
    ...
    var Redactor = function(element, options)
    {
        ...
        this.opts = $.extend({
            ...
            '<a href="javascript:void(null);" id="abaImage">' + RLANG.choose + '</a>' +
    ...
    Redactor.prototype = {
        ...
        build: function()
        {
            ...
            // frame
            this.$frame = $('<iframe frameborder="0" scrolling="auto" style="height: 200px;" class="redactor_frame"></iframe>');
        ...
        formatting: function(html)
        {
            ...
            if ($.browser.msie)
            {
                ...
                html = html.replace(/style="(.*?)"/gi, function(w) {
