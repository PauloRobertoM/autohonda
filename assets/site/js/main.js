...
// Timer1
function makeTimer1() {
			var endTime = new Date("December 23, 2017 24:00:00 PDT");
...
// window.$crisp=[];window.CRISP_WEBSITE_ID="92f1acb3-1814-4bfc-b522-41891291685d";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.im/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();
...
$(window).scroll(function(){
   if($(window).scrollTop() - $(".hero").scrollTop() - $(".hero").height() >= -120) {
      $(".navbar").addClass("bg");
			$(".hero--text").addClass("-opacity0");
   } else {
      $(".navbar").removeClass("bg");
			$(".hero--text").removeClass("-opacity0");
   }
});
...
$( document ).ready(function() {
   ...
   $('.cont').click(function(){
      $("html, body").animate({ scrollTop: ($('.pronto').offset().top - 100)}, 700);
   })

   console.log($('.Icon svg'))

   $('.trei').click(function(){
      $("html, body").animate({ scrollTop: ($('.treina').offset().top - 100)}, 700);
   })

   $("#efeitoMaquina").typed({
      strings: ["a Web.", "o Mobile.","o Design.", "o Hardware.", "a sua Empresa.", "o seu Sonho.", "o Mundo..."],
      typeSpeed: 50
    });
...
$(document).ready(function() {
  $( "#vamo a" ).each(function() {
    $(this).hover (
      function() {
        $(this).children('span').fadeIn();
      }, function() {
        $(this).children('span').fadeOut();
        $('#social span').css('opacity','1');
      }
    );
  });
});
...
$('.sc-fjdhpX').value('Como a Mouse Labs pode te ajudar a melhorar o futuro ?')
