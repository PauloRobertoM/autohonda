...
?>
	<div class="row-fluid">
		<ul class="breadcrumb">
			...
			<li>
				<a href="<?php echo site_url('painel/'.$nameform); ?>">Cadastros de aprovação</a>
				<span class="divider">/</span>
			</li>
			<li class="active">Listagem dos cadastros de aprovação do sistema</li>
		</ul>
	</div>
